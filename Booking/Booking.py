...
def main():
    ...
    with sync_playwright() as p:
        ...
        # IMPORTANT Note: Change dates to future date or it won't work
...
# return a list of hotels
        ...
        df.to_excel('Booking\hotels_list.xlsx', index=True) 
        df.to_csv('Booking\hotels_list.csv', index=True) 
